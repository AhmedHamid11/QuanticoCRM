...
<form onsubmit={handleSubmit} class="space-y-6">
	...
	<div class="flex justify-end gap-3 pt-4 border-t">
		<button
			type="submit"
			disabled={submitting}
			class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-600/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
		>
			{#if submitting}

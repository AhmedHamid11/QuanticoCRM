	...
	<div class="flex items-center justify-between">
		...
		<div class="flex items-center space-x-3">
			<button
				...
				class="inline-flex items-center px-4 py-2 text-sm font-medium text-black bg-primary border border-transparent rounded-md hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
			>
								...
								{#if editingUserId === user.id}
									<div class="flex items-center space-x-2">
										<select
											...
											class="block w-24 rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary text-sm"
										>
											{#if auth.isOwner}
								...
								{#if auth.isAdmin && editingUserId !== user.id}
									...
									{#if auth.isOwner || user.role !== 'owner'}
										<button
											...
											class="text-primary hover:text-blue-900 mr-4"
										>
											Edit Role
										</button>
									{/if}
			...
			<div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
				...
				<div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
					<button
						...
						class="inline-flex w-full justify-center rounded-md bg-primary px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary sm:ml-3 sm:w-auto disabled:opacity-50 disabled:cursor-not-allowed"
					>
						{#if isInviting}

...
<div class="space-y-4">
	...
	{:else if tripwires.length === 0}
		<div class="text-center py-12 text-gray-500">
			No tripwires found. <a href="/admin/tripwires/new" class="text-primary hover:underline">Create one</a>
		</div>
	{:else}
					...
					{#each tripwires as tw (tw.id)}
						<tr class="hover:bg-gray-50">
							<td class="px-6 py-4 whitespace-nowrap">
								<a href="/admin/tripwires/{tw.id}" class="text-primary hover:underline font-medium">
									{tw.name}
								</a>
								{#if tw.description}
							...
							<td class="px-6 py-4 whitespace-nowrap">
								<button
									...
									class="relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 {tw.enabled ? 'bg-primary' : 'bg-gray-200'}"
								>
									<span
							...
							<td class="px-6 py-4 whitespace-nowrap text-right text-sm">
								...
								<a href="/admin/tripwires/{tw.id}" class="text-primary hover:underline mr-4">
									Edit
								</a>

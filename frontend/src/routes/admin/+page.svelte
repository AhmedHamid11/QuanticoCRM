<script lang="ts">
	...
	const tiles: Tile[] = [
		...
		{ title: 'Mirrors', description: 'Configure data ingestion schema contracts for external systems', href: '/admin/mirrors', borderColor: 'border-violet-500', iconColor: 'text-violet-500', iconPath: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4', section: 'Automation' },
		// System
		...
		{ title: 'Import Data', description: 'Bulk import records from CSV files with validation', href: '/admin/import', borderColor: 'border-sky-500', iconColor: 'text-sky-500', iconPath: 'M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12', section: 'System' },
	...
	const sectionOrder = ['Customization', 'Data Quality', 'Automation', 'System', 'Platform Administration'];

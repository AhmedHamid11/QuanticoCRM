...
<div class="space-y-6">
	...
	<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
		...
		<div class="col-span-full">
			<h2 class="text-lg font-medium text-gray-700 mb-4">Customization</h2>
		</div>

		<a
			href="/admin/entity-manager"
		...
		>
			<div class="flex items-start">
				...
				<div class="ml-4">
					<h3 class="text-lg font-medium text-gray-900">Entity Manager</h3>
					<p class="mt-1 text-sm text-gray-500">
						View and manage entities, their fields, and layouts
					</p>
				</div>
			</div>
		</a>
		...
		>
			<div class="flex items-start">
				...
				<div class="ml-4">
					...
					<p class="mt-1 text-sm text-gray-500">
						Configure toolbar tabs and their order
					</p>
				</div>
			</div>
		</a>
		...
		<a
			href="/admin/settings"
			class="bg-white shadow rounded-lg p-6 hover:shadow-md transition-shadow border-l-4 border-gray-500"
		>
			<div class="flex items-start">
				<div class="flex-shrink-0">
				...
				<div class="ml-4">
					<h3 class="text-lg font-medium text-gray-900">Org Settings</h3>
					<p class="mt-1 text-sm text-gray-500">
						Configure homepage and organization settings
					</p>
				</div>
			</div>
		</a>
		...
		<a
			href="/admin/pages"
			class="bg-white shadow rounded-lg p-6 hover:shadow-md transition-shadow border-l-4 border-cyan-500"
		>
			<div class="flex items-start">
				<div class="flex-shrink-0">
				...
				<div class="ml-4">
					<h3 class="text-lg font-medium text-gray-900">Custom Pages</h3>
					<p class="mt-1 text-sm text-gray-500">
						Create and manage custom pages with iframes and components
					</p>
				</div>
			</div>
		</a>
		...
		>
			<div class="flex items-start">
				...
				<div class="ml-4">
					<h3 class="text-lg font-medium text-gray-900">PDF Templates</h3>
					<p class="mt-1 text-sm text-gray-500">
						Customize PDF output for quotes and documents
					</p>
				</div>
			</div>
		</a>
		...
		>
			<div class="flex items-start">
				...
				<div class="ml-4">
					<h3 class="text-lg font-medium text-gray-900">Tripwires</h3>
					<p class="mt-1 text-sm text-gray-500">
						Configure webhook triggers for entity events
					</p>
				</div>
			</div>
		</a>
		...
		>
			<div class="flex items-start">
				...
				<div class="ml-4">
					<h3 class="text-lg font-medium text-gray-900">Screen Flows</h3>
					<p class="mt-1 text-sm text-gray-500">
						Create interactive wizards with screens, decisions, and actions
					</p>
				</div>
			</div>
		</a>
		...
		<a
			...
			class="bg-white shadow rounded-lg p-6 hover:shadow-md transition-shadow border-l-4 border-indigo-500"
		>
			<div class="flex items-start">
				<div class="flex-shrink-0">
		...
		>
			<div class="flex items-start">
				...
				<div class="ml-4">
					<h3 class="text-lg font-medium text-gray-900">Data Explorer</h3>
					<p class="mt-1 text-sm text-gray-500">
						Query database and export data
					</p>
				</div>
			</div>
		</a>
		...
		<a
			...
			class="bg-white shadow rounded-lg p-6 hover:shadow-md transition-shadow border-l-4 border-yellow-500"
		>
			<div class="flex items-start">
				<div class="flex-shrink-0">
				...
				<div class="ml-4">
					...
					<p class="mt-1 text-sm text-gray-500">
						View security events and compliance audit trail
					</p>
				</div>
			</div>
		</a>
		...
		<button
			...
			class="bg-white shadow rounded-lg p-6 hover:shadow-md transition-shadow border-l-4 border-rose-500 text-left w-full disabled:opacity-50 disabled:cursor-not-allowed"
		>
			<div class="flex items-start">
				<div class="flex-shrink-0">
				...
				<div class="ml-4">
					<h3 class="text-lg font-medium text-gray-900">
						{isReprovisioning ? 'Repairing...' : 'Repair Metadata'}
					</h3>
					<p class="mt-1 text-sm text-gray-500">
						Re-create default entities, fields, layouts if missing or corrupted
					</p>
				</div>
			</div>
		</button>

		<!-- Platform Admin Section (only visible to platform admins, not during impersonation) -->
		{#if auth.isPlatformAdmin && !auth.isImpersonation}
			<div class="col-span-full mt-6">
				<h2 class="text-lg font-medium text-gray-700 mb-4">Platform Administration</h2>
			</div>

			<a
				href="/admin/platform"
				class="bg-white shadow rounded-lg p-6 hover:shadow-md transition-shadow border-l-4 border-purple-600"
			>
				<div class="flex items-start">
					<div class="flex-shrink-0">
					...
					<div class="ml-4">
						<div class="flex items-center">
							<h3 class="text-lg font-medium text-gray-900">Platform Console</h3>
							<span class="ml-2 inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-purple-100 text-purple-800">
								Admin
							</span>
						</div>
						<p class="mt-1 text-sm text-gray-500">
							View all organizations and impersonate customers
						</p>
					</div>
				</div>
			</a>

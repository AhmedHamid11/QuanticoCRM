...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/(auth)" | "/" | "/accept-invite" | "/accounts" | "/accounts/new" | "/accounts/[id]" | "/accounts/[id]/edit" | "/admin" | "/admin/api-tokens" | "/admin/audit-logs" | "/admin/changelog" | "/admin/data-explorer" | "/admin/entity-manager" | "/admin/entity-manager/[entity]" | "/admin/entity-manager/[entity]/bearings" | "/admin/entity-manager/[entity]/fields" | "/admin/entity-manager/[entity]/layouts" | "/admin/entity-manager/[entity]/layouts/[type]" | "/admin/entity-manager/[entity]/related-lists" | "/admin/entity-manager/[entity]/validation-rules" | "/admin/entity-manager/[entity]/validation-rules/new" | "/admin/entity-manager/[entity]/validation-rules/[id]" | "/admin/flows" | "/admin/flows/new" | "/admin/flows/[id]" | "/admin/import" | "/admin/navigation" | "/admin/pages" | "/admin/pages/[id]" | "/admin/pdf-templates" | "/admin/pdf-templates/[id]" | "/admin/platform" | "/admin/settings" | "/admin/settings/webhooks" | "/admin/tripwires" | "/admin/tripwires/new" | "/admin/tripwires/[id]" | "/admin/tripwires/[id]/logs" | "/admin/users" | "/contacts" | "/contacts/new" | "/contacts/[id]" | "/contacts/[id]/edit" | "/(auth)/forgot-password" | "/(auth)/login" | "/p" | "/p/[slug]" | "/quotes" | "/quotes/new" | "/quotes/[id]" | "/quotes/[id]/edit" | "/(auth)/register" | "/(auth)/reset-password" | "/settings" | "/settings/profile" | "/tasks" | "/tasks/new" | "/tasks/[id]" | "/tasks/[id]/edit" | "/[entity=customentity]" | "/[entity=customentity]/new" | "/[entity=customentity]/[id]" | "/[entity=customentity]/[id]/edit";
		RouteParams(): {
		...
		Pathname(): "/" | "/accept-invite" | "/accept-invite/" | "/accounts" | "/accounts/" | "/accounts/new" | "/accounts/new/" | `/accounts/${string}` & {} | `/accounts/${string}/` & {} | `/accounts/${string}/edit` & {} | `/accounts/${string}/edit/` & {} | "/admin" | "/admin/" | "/admin/api-tokens" | "/admin/api-tokens/" | "/admin/audit-logs" | "/admin/audit-logs/" | "/admin/changelog" | "/admin/changelog/" | "/admin/data-explorer" | "/admin/data-explorer/" | "/admin/entity-manager" | "/admin/entity-manager/" | `/admin/entity-manager/${string}` & {} | `/admin/entity-manager/${string}/` & {} | `/admin/entity-manager/${string}/bearings` & {} | `/admin/entity-manager/${string}/bearings/` & {} | `/admin/entity-manager/${string}/fields` & {} | `/admin/entity-manager/${string}/fields/` & {} | `/admin/entity-manager/${string}/layouts` & {} | `/admin/entity-manager/${string}/layouts/` & {} | `/admin/entity-manager/${string}/layouts/${string}` & {} | `/admin/entity-manager/${string}/layouts/${string}/` & {} | `/admin/entity-manager/${string}/related-lists` & {} | `/admin/entity-manager/${string}/related-lists/` & {} | `/admin/entity-manager/${string}/validation-rules` & {} | `/admin/entity-manager/${string}/validation-rules/` & {} | `/admin/entity-manager/${string}/validation-rules/new` & {} | `/admin/entity-manager/${string}/validation-rules/new/` & {} | `/admin/entity-manager/${string}/validation-rules/${string}` & {} | `/admin/entity-manager/${string}/validation-rules/${string}/` & {} | "/admin/flows" | "/admin/flows/" | "/admin/flows/new" | "/admin/flows/new/" | `/admin/flows/${string}` & {} | `/admin/flows/${string}/` & {} | "/admin/import" | "/admin/import/" | "/admin/navigation" | "/admin/navigation/" | "/admin/pages" | "/admin/pages/" | `/admin/pages/${string}` & {} | `/admin/pages/${string}/` & {} | "/admin/pdf-templates" | "/admin/pdf-templates/" | `/admin/pdf-templates/${string}` & {} | `/admin/pdf-templates/${string}/` & {} | "/admin/platform" | "/admin/platform/" | "/admin/settings" | "/admin/settings/" | "/admin/settings/webhooks" | "/admin/settings/webhooks/" | "/admin/tripwires" | "/admin/tripwires/" | "/admin/tripwires/new" | "/admin/tripwires/new/" | `/admin/tripwires/${string}` & {} | `/admin/tripwires/${string}/` & {} | `/admin/tripwires/${string}/logs` & {} | `/admin/tripwires/${string}/logs/` & {} | "/admin/users" | "/admin/users/" | "/contacts" | "/contacts/" | "/contacts/new" | "/contacts/new/" | `/contacts/${string}` & {} | `/contacts/${string}/` & {} | `/contacts/${string}/edit` & {} | `/contacts/${string}/edit/` & {} | "/forgot-password" | "/forgot-password/" | "/login" | "/login/" | "/p" | "/p/" | `/p/${string}` & {} | `/p/${string}/` & {} | "/quotes" | "/quotes/" | "/quotes/new" | "/quotes/new/" | `/quotes/${string}` & {} | `/quotes/${string}/` & {} | `/quotes/${string}/edit` & {} | `/quotes/${string}/edit/` & {} | "/register" | "/register/" | "/reset-password" | "/reset-password/" | "/settings" | "/settings/" | "/settings/profile" | "/settings/profile/" | "/tasks" | "/tasks/" | "/tasks/new" | "/tasks/new/" | `/tasks/${string}` & {} | `/tasks/${string}/` & {} | `/tasks/${string}/edit` & {} | `/tasks/${string}/edit/` & {} | `/${string}` & {} | `/${string}/` & {} | `/${string}/new` & {} | `/${string}/new/` & {} | `/${string}/${string}` & {} | `/${string}/${string}/` & {} | `/${string}/${string}/edit` & {} | `/${string}/${string}/edit/` & {};

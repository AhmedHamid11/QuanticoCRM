  ...
  $$renderer.component(($$renderer2) => {
    ...
    if (!token && true) {
      ...
      $$renderer2.push("<!--[!-->");
      {
        ...
        $$renderer2.push(`<!--]--></button></div> <div class="text-center"><a href="/login" class="font-medium text-blue-600 hover:text-blue-500">Back to sign in</a></div></form>`);
      }
      $$renderer2.push(`<!--]-->`);
    }

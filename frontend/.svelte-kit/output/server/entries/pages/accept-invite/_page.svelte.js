...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (!token) {
      ...
      $$renderer2.push(`<!--]--></button></div> <p class="text-center text-sm text-gray-600">Already have an account? <a href="/login" class="font-medium text-blue-600 hover:text-blue-600">Sign in</a></p></form>`);
    }

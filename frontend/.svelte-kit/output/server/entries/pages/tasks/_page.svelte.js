...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="space-y-4"><div class="flex justify-between items-center"><h1 class="text-2xl font-bold text-gray-900">Tasks</h1> <a href="/tasks/new" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-600/90">+ New Task</a></div> <div class="flex gap-4 flex-wrap items-center"><div class="flex-1 min-w-64 relative"><input type="text"${attr("value", search)} placeholder="Search tasks..." class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"/> <svg class="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M9 3.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11zM2 9a7 7 0 1112.452 4.391l3.328 3.329a.75.75 0 11-1.06 1.06l-3.329-3.328A7 7 0 012 9z" clip-rule="evenodd"></path></svg></div> `);
    $$renderer2.select(
      {
        value: statusFilter,
    ...
    if (filterQuery) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<span class="ml-1 text-xs bg-blue-600 text-white px-1.5 py-0.5 rounded-full">1</span>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }

...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="space-y-6"><div><h1 class="text-2xl font-bold text-gray-900">Merge History</h1> <p class="mt-1 text-sm text-gray-500">View recent merge operations. You can undo merges within 30 days.</p></div> <div class="bg-white rounded-lg shadow p-4"><div class="flex items-center gap-4"><label class="flex items-center gap-2"><span class="text-sm font-medium text-gray-700">Entity Type:</span> `);
    $$renderer2.select(
      {
        value: entityFilter,
    ...
    $$renderer2.push(`</label></div></div> <div class="bg-white rounded-lg shadow overflow-hidden">`);
    if (loading) {
      $$renderer2.push("<!--[-->");
